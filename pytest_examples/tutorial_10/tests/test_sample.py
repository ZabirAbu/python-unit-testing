...
from tutorial_10.myapp.sample import random_sum, silly


@mock.patch("tutorial_10.myapp.sample.random.randint")
...
@mock.patch("tutorial_10.myapp.sample.random.randint")
@mock.patch("tutorial_10.myapp.sample.time.time")
@mock.patch("tutorial_10.myapp.sample.requests.get")
